...
void runDispersion()
{
    ...
    cout << "Дисперсия = " << setprecision(numeric_limits<double>::max_digits10) << solveSquareMathExpectation(x, arraySize)-solveMathExpectation(x, arraySize)*solveMathExpectation(x, arraySize) << endl << endl;
